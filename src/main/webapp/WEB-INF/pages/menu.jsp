...
<header>
    <nav class="fixed top-0 left-0 right-0 bg-white border-b border-slate-100 z-50 h-16 grid grid-cols-3 items-center px-6 shadow-sm">
        ...
        <div class="flex items-center gap-4 justify-self-end">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <span class="hidden lg:inline text-sm font-semibold text-slate-700 mr-2">
                        Hello, <b>${pageContext.request.remoteUser}</b>!
                    </span>

                    <a href="${pageContext.request.contextPath}/Logout"
                       class="nav-link-custom text-sm font-semibold transition-colors text-slate-500 hover:text-slate-800 no-underline border border-slate-200 px-3 py-1 rounded-lg">
                        Logout
                    </a>
                </c:otherwise>
            </c:choose>
